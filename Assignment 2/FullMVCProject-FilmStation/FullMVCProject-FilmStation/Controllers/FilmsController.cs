...
using FullMVCProject_FilmStation.Models;
...
namespace FullMVCProject_FilmStation.Controllers
{
    public class FilmsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "FilmName, FilmLength, ReleaseDate, AgeRating, Language, FilmRating")] Film film)
        {
